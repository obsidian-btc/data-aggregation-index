...
context "Get next batch operation is configured" do
  ...
  batch_copied = Controls::Update::Messages::BatchCopied.example stream_name: update_stream
  ...
  context "Session is specified" do
    ...
    get_next_batch = Update::GetNextBatch.build batch_copied, session: session
